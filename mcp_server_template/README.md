...
- [`src/mcp_server/conf/config.yaml`](src/mcp_server/conf/config.yaml)
  - `server.name`
  - transport defaults if needed
- [`src/mcp_server/app.py`](src/mcp_server/app.py)
  - replace `hello` with the first real domain behavior
- [`src/mcp_server/main.py`](src/mcp_server/main.py)
